...
`[Todos os tipos de usuários tem facilidade facilidade para realizar uma compra?]`

## Objetivo geral

`[Identificar os principais aspectos que dificultam as pessoas incapacitadas na realização de compras e como elas podem ser resolvidas para se tornar acessível à todos?]`

## Objetivos específicos

1. `[Mapear quais dificuldades que são comuns entre as pessoas]`
2. `[Analisar e comparar tais dificuldades para que possa ser sugerido uma resolução ampla]`
3. `[Descobrir o perfil dos usuários com dificuldades]`
4. `[Testar outras possibilidades de resolução que poderão ser acessíveis à todos]`
